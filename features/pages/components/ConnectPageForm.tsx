    ...
    <Card className="border-neutral-200 dark:border-neutral-800 shadow-sm overflow-hidden">
      <CardHeader className="pb-4">
        ...
        <CardDescription className="text-sm">
          {mode === 'oauth'
            ? (t('pages.connect_description_oauth') || 'Conecta tu cuenta de Facebook para sincronizar automáticamente tus páginas.')
            : 'Conecta una página manualmente usando su ID y un Token de Acceso técnico.'
          }
        </CardDescription>
      </CardHeader>
        ...
        {mode === 'oauth' ? (
          <div className="animate-in fade-in slide-in-from-top-2 duration-300">
            ...
            <p className="mt-4 text-[11px] text-neutral-500 text-center leading-relaxed">
              Al conectar, TECHUS obtendrá permiso para leer tus páginas y publicar contenido programado por ti.
            </p>
          </div>
        ) : (
          <ManualConnectForm />
