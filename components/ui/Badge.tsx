...
function Badge({ className, variant = "default", ...props }: BadgeProps) {
  const variants = {
    ...
    outline: "text-neutral-950 dark:text-neutral-50 border border-neutral-200 dark:border-neutral-800",
    success: "border-transparent bg-green-500 text-white hover:bg-green-600 dark:bg-green-900 dark:text-white",
  };
